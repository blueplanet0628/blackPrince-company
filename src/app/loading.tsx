...
export default function Loading() {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-cyan-50 overflow-hidden">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="mt-8 animate-fade-pulse">
          ...
          <span className="text-[#00c7f1]">...</span>
        </div>
      </div>
