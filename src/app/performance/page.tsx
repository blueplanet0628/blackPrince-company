    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 sm:px-10">
        <div ref={headerRef} className="text-center mb-16">
          <p className="text-blue-200 text-sm font-medium mb-2">開発アプローチの違い</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">私たちが選ばれる理由</h1>
          <p className="text-blue-100 max-w-3xl mx-auto text-lg">
            10年以上の開発経験で培ったノウハウと、お客様に寄り添う姿勢。
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">従来の開発会社</h3>
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <Users className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">明瞭なコミュニケーション</h3>
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">部分的なサポート</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px]">
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <Clock className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">ワンストップサポート</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px] md:ml-auto">
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">品質のバラつき</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px]">
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <Shield className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">安定した高品質</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px] md:ml-auto">
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">長い開発期間</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px]">
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <Rocket className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">迅速な対応</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px] md:ml-auto">
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">単発の取引関係</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px]">
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <HeartHandshake className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">長期的なパートナーシップ</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px] md:ml-auto">
          ...
          <div className="perf-row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start md:items-center gap-6 md:gap-8">
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">限られた技術領域</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px]">
            ...
            <div className="flex-1">
              <div className="flex items-start md:items-center gap-4 md:flex-row-reverse">
                <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#00c7f1]/20 rounded-lg flex-shrink-0 border border-[#00c7f1]/30">
                  <Code className="w-7 h-7 md:w-8 md:h-8 text-[#00c7f1]" />
                </div>
                <div className="md:text-right">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-1">幅広い技術スタック</h3>
                  <p className="text-blue-100 text-sm md:text-base max-w-[374px] md:ml-auto">
